...
for expr in [
    "document.getElementById('primary-question-wrap').innerHTML",
    "document.getElementById('second-question-wrap').innerHTML",
    "document.getElementById('app').innerHTML.substring(0,500)",
]:
    try:
        val = cdp_eval(ws, expr)
        print("===", expr[:50], "===", flush=True)
